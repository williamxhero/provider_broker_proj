...
scp $Wheel "$Project\scripts\install.sh" "$Project\scripts\smoke.py" "$Project\scripts\transport_matrix.py" "$Project\scripts\firewall.sh" "$Project\deploy\provider-broker.service" "$Project\deploy\provider-broker-firewall.service" "${HostName}:$Stage/"
