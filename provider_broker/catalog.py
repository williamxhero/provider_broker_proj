...
# Management-facing model contract recovered from the approved Stage mapping.
# Runtime inventory may contain more names, but only these models belong in the
...
APPROVED_STAGE_MODELS = {
    ...
    "expert": (
        "gpt-5.6-sol", "gpt-5.5", "claude-opus-5", "claude-opus-4-8", "glm-5.3",
    ),
}
